...
<body id="page-top">
	...
	<section class="page-section portfolio" id="portfolio">
		<div class="jumbotron">
			<h2>
				Registro Dueños <i style='font-size: 24px' class='fas'>&#xf6be;</i><i
				...
				<tbody id="myTable">
					<c:forEach items="${duenios}" var="d">
						<tr>
							...
							<td>
								<form action="cargarduenio" id="modificar${d.id}" method="post">
									<input type="hidden" name="id" value="${d.id}"> <input
										type="submit" value="Actualizar datos" class="btn btn-info">
								</form>
							</td>
						</tr>
					</c:forEach>
